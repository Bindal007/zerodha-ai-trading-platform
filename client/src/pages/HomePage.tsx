...
const HomePage = () => {
    ...
    useEffect(() => {
        document.title = 'Home | Zerodha.ai';
    }, []);
        ...
        <div className='dark:bg-darkBg flex flex-col min-h-screen items-center justify-center overflow-hidden'>
                ...
                <section className='text-gray-600 body-font'>
                    <div className='container mx-auto flex md:px-16 py-24 lg:flex-row flex-col items-center'>
                        <div className='lg:flex-grow lg:w-1/2 pr-0 lg:pr-24 flex flex-col lg:items-start lg:text-left mb-16 lg:mb-0 items-center text-center'>
                            <h1 className='title-font sm:text-5xl text-3xl mb-4 font-medium text-gray-900 dark:text-white'>Zerodha.ai</h1>
            ...
            <section className='text-gray-600 body-font p-10'>
                <div className='container mx-auto flex md:px-16 pb-24 lg:flex-row flex-col items-center'>
                    <div className='lg:flex-grow lg:w-1/2 pr-0 lg:pr-24 flex flex-col lg:items-start lg:text-left mb-16 lg:mb-0 items-center text-center'>
                        <h1 className='title-font sm:text-3xl text-3xl mb-4 font-medium text-gray-900 dark:text-white'>What is Zerodha.ai?</h1>

                        <p className='mb-8 text-md lg:text-lg leading-relaxed dark:text-gray-300'>
                            Zerodha.ai is a full-stack portfolio project. The technologies used were the MERN stack, along with TypeScript, TailwindCSS,
                            SASS, Redux, Socket.io, JWT, and Apollo GraphQL.
                        </p>
                        <div className='flex justify-center flex-nowrap'>
                            <a
                                href='https://github.com/Bindal007/zerodha-ai-trading-platform'
                                aria-label='GitHub'
                                target='_blank'
