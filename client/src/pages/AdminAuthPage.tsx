...
const initialState = { username: '', password: '', confirmPassword: '', type: "Admin" };
...
const AdminAuth = () => {
    ...
    const handleSubmit = (e: any) => {
        e.preventDefault();
        setIsLoading(true);
            loginMutation({ variables: { username: form.username, password: form.password, type: "Admin" } })
            .then(({ data }) => {
                setErrors('');
                ...
                {!auth?.user ? (
                    <>
                        <div className='p-8 relative'>
                            ...
                            <h3 className='mt-1 text-xl font-medium text-center text-gray-600 dark:text-gray-200'>Welcome Admin!</h3>
